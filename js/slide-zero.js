...
var arr=['/img/foto1-mobile.png','/img/foto2-mobile.png','/img/foto3-mobile.png','/img/foto4-mobile.png','/img/foto5-mobile.png','/img/foto6-mobile.png','/img/foto7-mobile.png']; //an array of image sources
...
$(document).ready(function () {
    ...
    $('#0').css({'background':'#993CBA', 'color':'#993CBA'});//sets the background of the first small circle to black
    ...
    function autoSlide(arr,interval){
        ...
        setInterval(function () {
            ...
            $('#'+pos).css({'background':'#993CBA', 'color':'#993CBA'});//sets background-color of circle representing the current active image to black
...
function circleClick(position) {
    if(position!=pos){
        ...
        $('#'+position).css({'background':'#993CBA', 'color':'#993CBA'});//sets background-color of circle representing the current active image to black
        $('#'+(pos)).css({'background':'transparent', 'color':'#993CBA'});//sets background-color of circle before active to white
